...
;(function ($, window, document, undefined) {
    ...
    $.idealforms.errors = {
        ...
        decimals:'必须是带3位小数的数字，整数以.000代替',
        twodecimals:'必须是带2位小数的数字，整数以.00代替',
        fourdecimals:'必须是带4位小数的数字，整数以.0000代替',
        vehicle:'输入的车牌格式不对'
    ...
    var getFilters = function () {
        ...
        var filters = {
            ...
            decimals :{
                regex: /^\d+(\.\d{3})$/,
                error: $.idealforms.errors.decimals
            },
            twodecimals :{
                regex: /^\d+(\.\d{2})$/,
                error: $.idealforms.errors.twodecimals
            },
            fourdecimals :{
                regex: /^\d+(\.\d{4})$/,
                error: $.idealforms.errors.fourdecimals
            },

            vehicle :{
                regex: /^[京津沪渝冀豫云辽黑湘皖鲁新苏浙赣鄂桂甘晋蒙陕吉闽贵粤青藏川宁琼使领A-Z]{1}[A-Z]{1}[A-Z0-9]{4}[A-Z0-9挂学警港澳]{1}$/,
                error: $.idealforms.errors.vehicle
            }
